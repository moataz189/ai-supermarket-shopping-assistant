...
RELEVANCE_PROMPT = (
    ...
    "are not a potato; tomato sauce/paste/puree is not a raw tomato). A raw/plain form "
    "of the requested item is almost always what's wanted — a cooked, fried, battered, "
    "jarred/canned, or otherwise "
    ...
    "dog food, and similar), even when it's genuinely made with the requested "
    "ingredient (e.g. cat food containing tuna is not tuna). When a "
