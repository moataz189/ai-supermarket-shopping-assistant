...
RELEVANCE_PROMPT = (
    ...
    "prepared snack or dish made from it, appliance/tool, or other secondary descriptor "
    "of a genuinely different product (e.g. a rice-cooker appliance is not rice; milk "
    "chocolate or a dairy-flavored pastry is not plain milk; banana-flavored cereal is "
    "not a banana; fried onion rings are not a plain onion; potato chips are not a "
    "potato). A raw/plain form of the requested item is almost always what's wanted — "
    "a cooked, fried, battered, or otherwise processed snack or prepared dish is a "
    "different product even when it's genuinely made from the requested item. Also "
    ...
    "party balloons are not rice; a lemon-scented dish soap is not a lemon). When a "
