...
RELEVANCE_PROMPT = (
    ...
    "pastry is not plain milk; banana-flavored cereal is not a banana; fried onion "
    "rings are not a plain onion; potato chips are not a potato; tomato sauce/paste/"
    "puree is not a raw tomato). A raw/plain form of the requested item is almost "
    "always what's wanted — a cooked, fried, battered, jarred/canned, or otherwise "
    "processed snack, sauce, or prepared dish is a different product even when it's "
    "genuinely made from the requested item. Also "
