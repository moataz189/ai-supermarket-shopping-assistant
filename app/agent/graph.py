...
def build_graph(
    ...
    graph.add_node("build_shufersal_cart", make_build_retailer_cart("shufersal", client, llm))
    graph.add_node("build_rami_levy_cart", make_build_retailer_cart("rami_levy", client, llm))
